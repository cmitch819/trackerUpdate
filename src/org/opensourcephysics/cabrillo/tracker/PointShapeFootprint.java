 ...
 * Modified on August 11 2022 by Clara Mitchinson
 */
public class PointShapeFootprint implements Footprint, Cloneable {
  ...
  private static final PointShapeFootprint CROSS;
  ...
  static {
    ...
    cross.moveTo(-w, 0);
    cross.lineTo(w, 0);
    CROSS = new PointShapeFootprint("Footprint.Cross", cross); //$NON-NLS-1$
    footprints.add(CROSS);
