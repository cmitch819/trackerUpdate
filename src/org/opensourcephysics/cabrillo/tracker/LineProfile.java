...
public class LineProfile extends TTrack {
  ...
  static {
  	dataVariables = new String[] {"n", "x", "y", "R", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
  			"G", "B", "luma", "pixels", Tracker.THETA}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
  	fieldVariables = new String[0]; // no number fields used except integer spread
  	formatVariables = new String[] {"xy", "RGB", "luma", Tracker.THETA}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		formatDescriptionMap.put(formatVariables[3], TrackerRes.getString("LineProfile.Data.Angle")); //$NON-NLS-1$ 
