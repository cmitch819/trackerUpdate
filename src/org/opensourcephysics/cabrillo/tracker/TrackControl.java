 ...
 * Modified on August 10 2022 by Clara Mitchinson
 */
public class TrackControl extends JDialog
  ...
  protected KeyListener pointListener_0;
  protected KeyListener pointListener_1;
  protected KeyListener pointListener_2;
  protected KeyListener pointListener_3;
  protected KeyListener pointListener_4;
  protected KeyListener pointListener_5;
  protected KeyListener pointListener_6;
  protected KeyListener pointListener_7;
  protected KeyListener pointListener_8;
  protected KeyListener pointListener_9;
  protected ArrayList<KeyListener> keys = new ArrayList<KeyListener>() {{
	  add(pointListener_0);
	  add(pointListener_1);
	  add(pointListener_2);
	  add(pointListener_3);
